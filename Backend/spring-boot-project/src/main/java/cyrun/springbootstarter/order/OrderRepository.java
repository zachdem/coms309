...
public interface OrderRepository extends JpaRepository<Order, Integer> {
	...
	@Modifying
	@Transactional
	@Query(value = "INSERT INTO orders_table (item_id, customer_id, pending_order) " + 
			"SELECT t2.item_id, t3.user_id, 'Yes' from locations_table t1, items_table t2, users_table t3 " + 
...
>>>>>>> 6acc83dfe305b5e82a042c1975835685ae1c9a96
}
