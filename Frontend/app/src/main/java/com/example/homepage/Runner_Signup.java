...
public class Runner_Signup extends AppCompatActivity {



    private String urlJsonObj = "http://coms-309-ks-6.misc.iastate.edu:8080/runner_signup";

    private TextView txtResponse;
    private Button RunnersignUpButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RunnersignUpButton = findViewById(R.id.sign_up_button);


        RunnersignUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void sendSignUpRequest(String firstName, String lastName, String username, String password, Integer isuID, Integer routingNumber, Integer accountNumber, String netID) {
        try { // following the same format as the User Sign Up
